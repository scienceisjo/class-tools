...
- **🏡 우리 반 추억 마을:** https://scienceisjo.github.io/class-tools/memory-village/
...
| 우리 반 추억 마을 | 학기말 회고·다짐 학급 추억 공간. 내 캐릭터로 마을을 돌아다니며 다짐·명장면·행사·응원을 남기고 친구 마음에 ❤️ 공감. Supabase 실시간(방 코드 `?room=`)·발표 모드. | [memory-village/](memory-village/) |
