...
| 자비스 | 수업 시작에 3~5분 재미로 보여주는 아이언맨 JARVIS 데모. **손뼉 두 번**에 부팅해 "Welcome home, sir."(영어 음성 + 한글 자막), 음성으로 날씨·시간·시스템 진단·타이머·브리핑 호출. 교실 소음으로 음성이 안 먹혀도 숫자키로 똑같이 조작되는 키보드 백도어 내장. 마이크가 필요하므로 크롬·엣지에서 열 것. | [jarvis/](jarvis/) |
